...
#define HALL_C_EXTI_15_Pin GPIO_PIN_15
#define HALL_C_EXTI_15_GPIO_Port GPIOA
#define HALL_C_EXTI_15_EXTI_IRQn EXTI15_10_IRQn
#define HALL_B_EXTI_3_Pin GPIO_PIN_3
#define HALL_B_EXTI_3_GPIO_Port GPIOB
#define HALL_B_EXTI_3_EXTI_IRQn EXTI3_IRQn
#define HALL_A_EXTI_4_Pin GPIO_PIN_4
#define HALL_A_EXTI_4_GPIO_Port GPIOB
#define HALL_A_EXTI_4_EXTI_IRQn EXTI4_IRQn
